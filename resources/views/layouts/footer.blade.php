                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-xl-7 col-lg-9 col-md-8">
                                    <div class="wantToWork-caption wantToWork-caption2">
                                        <h2><span id="lettalk">Do</span> you want to know more about me?</h2>
                                    </div>
                                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-8 col-lg-8">
                                <div class="footer-copy-right " style="text-align:center;">
                                    <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Ikhide Caleb </a>
  </p>
                                </div>
                            </div>
                        </div>
